...
#c.JupyterHub.data_files_path = '/Users/baart_f/.virtualenvs/main/share/jupyterhub'
...
c.Authenticator.admin_users = ["rhea"]
...
#
#  If empty, does not perform any additional restriction.
c.Authenticator.whitelist = ["user" + str(i) for  i in  range(6)] + [ "rhea" ]
